...
public class ScrollHandler {
    ...
    /* Constructor receives a float to determine where to create
     * Pipe & Grass objects.
     */
    ...
    public void update(float delta) {
        ...
        //Check if pipes scrolled left, and reset accordingly
    ...
    public boolean collides(Bird bird) {
        ...
        } else if(!pipe2.isScored() && pipe2.getX() + (pipe2.getWidth() / 2) <
                bird.getX()) {
            addScore(1);
            pipe2.setScored(true);
            AssetLoader.coin.play();
        } else if (!pipe3.isScored() && pipe3.getX() +(pipe3.getWidth() / 2) <
                bird.getX()) {
            addScore(1);
